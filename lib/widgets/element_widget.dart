      ...
      child: Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Icon(Icons.more_vert, color: kTextGray, size: 18.sp,),
                Gap(10.w),
                MyText(
                  widget.title,
                  fontSize: 16.sp,
            ...
            Row(
              ...
              children: [
                ButtonIcon(Icons.edit_outlined, onTap: (){},),
                Gap(10.w),
                ButtonIcon(Icons.visibility_outlined, onTap: (){},),
                Gap(10.w),
                ButtonIcon(Icons.copy_all, onTap: (){},),
                Gap(10.w),
                ButtonIcon(Icons.delete_outline, onTap: (){},),
              ],
            ),
          ],
        ),
